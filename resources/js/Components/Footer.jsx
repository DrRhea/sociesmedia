...
const Footer = () => {
    return (
        <footer className="max-w-screen-2xl w-full mx-auto lg:py-8 lg:px-16 py-6 px-4 text-primary-400 bg-primary-50">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        <li>Email: <a href="mailto:info@sociesmedia.id" className="hover:text-primary-500">info@sociesmedia.id</a></li>
                        <li>Phone: <a href="tel:+6281234567890" className="hover:text-primary-500">+62 812 3456 7890</a></li>
                        <li>Address: <span className="hover:text-primary-500">Jl. Dr. Setiabudhi No. 229 Bandung 40154</span></li>
                    </ul>
                </div>
            </div>
            ...
            {/* Social Media Icons */}
            <div className="mt-8 border-t border-primary-300 pt-4">
                <h4 className="font-semibold text-lg lg:text-xl mb-4">Follow Us</h4>
                <div className="flex space-x-4">
                    <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hover:text-primary-500">
                    ...
                    <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-primary-500">
                        <svg width="24" height="24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            {/* Icon Twitter */}
                    ...
                    <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-primary-500">
                        <svg width="24" height="24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            {/* Icon Instagram */}
